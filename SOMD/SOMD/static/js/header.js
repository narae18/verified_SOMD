...
page.addEventListener('scroll', function(event){
  ...
  if(prepreScroll != nowScroll){
    if(nowScroll <-1){
        ...
        if (preScroll - nowScroll > 5 &&(( headerState !="bottom")||(nowScroll <= maxScroll && headerState == "bottom")) ){
            // console.log("add");
            header.classList.add("add");
            header.classList.remove("remove");
            headerState = "add";
          ...
          else if(preScroll - nowScroll < -5 && ((headerState !="top")  || (nowScroll >= 0 && headerState == "top"))) {
            // console.log("remove");
            header.classList.remove("add");
            header.classList.add("remove");
            headerState = "remove";
...
var nowlink =  document.querySelector(".mainTitle").querySelector("div").innerText;
